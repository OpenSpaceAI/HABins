...
class MultiheadAttention_new(BaseModule):
    ...
    def __init__(self,
        ...
        self.attn = AiAModule(embed_dims, num_heads, attn_drop, **kwargs)
...
class PixelTransformerDecoder(BaseModule):
    ...
    def forward_prediction_heads(self, output, mask_features, cur_level=None, group_num=None):
        decoder_output = self.decoder_norm(output)
        if cur_level >= 1:
            for _ in range(cur_level):
                decoder_output = decoder_output.reshape(decoder_output.shape[0]*group_num,decoder_output.shape[1]//group_num,decoder_output.shape[2])        
